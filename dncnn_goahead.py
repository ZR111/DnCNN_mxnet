...
save_dir = os.path.join('/home/zr/DnCNN/TrainingCodes/dncnn_mx/models_goahead', args.model+'_'+'sigma'+str(args.sigma))
...
if __name__ == '__main__':
	...
	model.load_parameters(filename='/home/zr/DnCNN/TrainingCodes/dncnn_mx/models_goahead/mx_dncnn_sigma25/model_{epoch is 90(from 381)}.params', ctx=ctx)
	...
	for epoch in range(num_epochs):
		...
		filename = os.path.join(str(save_dir) + '/model_{epoch is ' + str(epoch+1) + '(from new 90)}.params')
